...
class AP:
    def __init__(self, ssid, psk, mac=None, mode="stdio", iface="mon0", iface2="", channel=1):
    ...
    def create_eapol_3(self, message_2):
        ...
        if given_mic != computed_mic:
            ...
            ## the computed mic failed, we print it out to see at wich step the calculation is wrong.
...
if __name__ == "__main__":
    ap = AP("MDP-25", "password1234", mode="iface", iface="mon0", iface2="mon0", channel=4)
    ap.run()
