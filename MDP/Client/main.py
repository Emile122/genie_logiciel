...
import getpass
import sys
from scapy.layers.dot11 import Dot11, Dot11AssoResp, Dot11Auth, Dot11EltRSN, RSNCipherSuite
...
def print_packet(pkt):
    if pkt.haslayer(Dot11) and pkt.haslayer(EAPOL):
        logging.info('Received EAPOL packet:')
...
if not sniffer.results:
    logging.error('Did not receive any packets')
    sys.exit(1)
